...
public class HTCCmonitor  extends DetectorMonitor {
    ...
    public void createHistos() {
        ...
        H2F adc1 = new H2F("adc_s1", "adc_s1", 200, 0, 20000, 8, 0.5, 8.5);
        adc1.setTitleX("ADC - value");
        adc1.setTitleY("PMT");
        adc1.setTitle("sector 1");
        H2F adc2 = new H2F("adc_s2", "adc_s2", 200, 0, 20000, 8, 0.5, 8.5);
        adc2.setTitleX("ADC - value");
        adc2.setTitleY("PMT");
        adc2.setTitle("sector 2");
        H2F adc3 = new H2F("adc_s3", "adc_s3", 200, 0, 20000, 8, 0.5, 8.5);
        adc3.setTitleX("ADC - value");
        adc3.setTitleY("PMT");
        adc3.setTitle("sector 3");
        H2F adc4 = new H2F("adc_s4", "adc_s4", 200, 0, 20000, 8, 0.5, 8.5);
        adc4.setTitleX("ADC - value");
        adc4.setTitleY("PMT");
        adc4.setTitle("sector 4");
        H2F adc5 = new H2F("adc_s5", "adc_s5", 200, 0, 20000, 8, 0.5, 8.5);
        adc5.setTitleX("ADC - value");
        adc5.setTitleY("PMT");
        adc5.setTitle("sector 5");
        H2F adc6 = new H2F("adc_s6", "adc_s6", 200, 0, 20000, 8, 0.5, 8.5);
